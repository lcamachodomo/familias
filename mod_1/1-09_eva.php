    ...
    <body>
        ...
        <section class="container">
            <div class="main">
                <div id="eva_09p1" class="mod">
                    <div class="cont row">
                        <div class="col-12 text-center ">
                            <h3 class="">¡Es momento de realizar la evaluación final del Módulo 01 - Oportunidades y desafíos de las TIC!</h3>
                            <p>A continuación usted encontrará una serie de preguntas de diferentes tipos.</p><p>Lea cada una de ellas y escoja la respuesta correcta.</p>
                        </div>
                    </div>
                    <button class="gotoModulePage btn btn-dark" data-page="2">Continuar</button>
                </div>
                <div id="eva_09p2" class="mod d-none">
                    <div class="question row">
                        <div class="col-12 text-center">
                            <h3 class="">1. Las personas menores de edad pueden utilizar los dispositivos digitales...</h3>
                            <p>Elija la opción que completa la frase correctamente.</p>
                        </div>

                    </div>
                    <div class="answers row" data-page="3">
                        <div class="col-12 answer" data-value="1">
                            <p>...solas y sin ninguna supervisión porque saben más que las personas adultas.</p>
                        </div>
                        <div class="col-12 answer" data-value="2">
                            <p>...solamente cuando los adultos pueden revisar y controlar lo que están haciendo.</p>
                        </div>
                        <div class="col-12 answer" data-value="3">
                            <p>...de forma independiente, con el acompañamiento de personas adultas.</p>
                        </div>
                ...
                <div id="eva_09p3" class="mod d-none">
                    ...
                    <div class="answers row" data-page="4">
                        <div class="col-6 answer" data-value="1">
                            <p>Vea videos musicales de moda</p>
                        </div>
                        <div class="col-6 answer" data-value="2">
                            <p>Sea víctima de sextorsión o abuso sexual</p>
                        </div>
                        <div class="col-6 answer" data-value="3">
                            <p>Se comunique con personas a distancia</p>
                        </div>
                        <div class="col-6 answer" data-value="4">
                            <p>Acceda a información sobre historia y cultura</p>
                        </div>
                ...
                <div id="eva_09p4" class="mod d-none">
                    ...
                    <div class="answers row" data-page="5">
                        ...
                        <div class="col-4 answer" data-value="2">
                            <p>Aprender algo nuevo</p>
                        </div>
                        <div class="col-4 answer" data-value="3">
                            <p>Comunicarse con otras personas</p>
                        </div>
                ...
                <div id="eva_09p5" class="mod d-none">
                    ...
                    <div class="answers row" data-page="6">
                        <div class="col-12 answer" data-value="1">
                            <p>No. Cuando uno no tomó las fotos originales no es responsable. Además al avisar a otros se está haciendo un bien a la sociedad.</p>
                        </div>
                        <div class="col-12 answer" data-value="2">
        ...
        <script>
            ...
            $(".gotoModulePage").click(function () {
                ...
                $(".answers .answer.active").each(function () {
            ...
            $(".answers .answer").click(function () {
                ...
                console.log("#eva_09p" + $(this).parent().data("page"));
