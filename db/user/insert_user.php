...
if ($row_cnt > 0) {
	...
	$query1 = "INSERT INTO module (`step`, `module`, `user`, `is_completed`) VALUES (1, 1, $last_id, 0), (2, 1, $last_id, 0), (3, 1, $last_id, 0), (4, 1, $last_id, 0), (5, 1, $last_id, 0), (6, 1, $last_id, 0), (7, 1, $last_id, 0); ";
	$mysqli->query($query1);
	$query2 = "INSERT INTO module (`step`, `module`, `user`, `is_completed`) VALUES (1, 2, $last_id, 0), (2, 2, $last_id, 0), (3, 2, $last_id, 0), (4, 2, $last_id, 0), (5, 2, $last_id, 0), (6, 2, $last_id, 0), (7, 2, $last_id, 0), (8, 2, $last_id, 0), (9, 2, $last_id, 0); ";
	$mysqli->query($query2);
